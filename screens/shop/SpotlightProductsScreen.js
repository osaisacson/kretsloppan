  ...
  return (
    <SaferArea>
      <Introduction
        ...
        text={
          'Mer återbruk åt folket! Här nere kan du se tillgängligt material, aktuella efterlysningar och projekt som håller på att byggas med återbruk. Lägg upp och hantera återbruk via din profilsida. Version: 1.0-beta2'
        }
      />
